...
<head>
  ...
  <!-- 내부 -->
  <link rel="stylesheet" href="//localhost/css/join.css">
  <script type="text/javascript" src="//localohst/js/join.js"></script>
</head>
<body>
  <header>
  ...
  <div class="wrap">
    ...
    <form action="joinAction.php" method="post" class="join_form" name="join" id="join" onsubmit="return user_join()">
<!-- 약관 동의 -->
