    ...
    <div class="header_wrap">
      <h1 class="logo"><a href="http://localhost/index.php">여기어때</a></h1>
      
      <h2 class="hide">상단 메뉴</h2>
      <ul class="top_menu">
        <li><a href="#" class="search_btn basic">검색</a></li>
        <li><a href="search.html" class="top_menu1 basic">내주변</a></li>
        <li><a href="http://localhost/event/event.php" class="top_menu2 basic">이벤트</a></li>
      <?php if(!$s_idx){ ?>
        <li><a href="http://localhost/login/login.php" class="top_menu3 basic">로그인</a></li>
      <?php }else{ ?>
        <li><a href="http://localhost/members/mymenu.php" class="top_menu4 basic">내정보</a></li>
        <li><a href="http://localhost/login/logout.php" class="top_menu3 logout">로그아웃</a></li>
      <?php } ?>
      </ul>  
    </div>    
    <div class="search">
      <div class="search-wrap">
        ...
        <div class="close">
          <a href="#"><img src="http://localhost/img/close_btn.png" alt="닫기"></a>
        </div>
      </div>
