...
<head>
  ...
  <script src="js/annEvent.js"></script>
</head>
<body>
  <!-- 헤더영역 -->
  ...
  <div class="wrap">
    <section class="tap-menu">
      <ul>
        ...
        <li><a href="annEvent.php" class="on">당첨자 발표</a></li> 
      </ul>
      <?php if($s_id == 'admin@admin'){?>
        <a href="annWrite.php" class="e_regi">게시글 등록하기</a>
      <?php };?>
      </section>
      <section class="board-wrap">
        ...
        <li class="board">
          <a href="#" class="list_que">
            ...
            <img src="//localhost/img/drop.jpg" class="drop_btn" alt="열기">
          </a>
          ...
          <?php if($s_id == 'admin@admin'){?>
            <div class="b_group">
              ...
              <a href="annModify.php?id=<?php echo $arr["ew_idx"];?>" class="mgr_btn mod_btn">수정</a>
            </div>
          <?php };?>
        </li>
        <?php }?>
